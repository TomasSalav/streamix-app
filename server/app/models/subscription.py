...
class Subscription(db.Model):
    ...
    _id_user_subscriber: Mapped[int] = mapped_column(db.Integer, db.ForeignKey('users.id'))
    _id_user_subscribed: Mapped[int] = mapped_column(db.Integer, db.ForeignKey('users.id'))
